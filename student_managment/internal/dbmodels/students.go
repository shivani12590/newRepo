...
type Student struct {
	StudentID int         `boil:"student_id" json:"student_id" toml:"student_id" yaml:"student_id"`
...
var StudentWhere = struct {
	...
	StudentID: whereHelperint{field: "\"students\".\"student_id\""},
	LastName:  whereHelpernull_String{field: "\"students\".\"last_name\""},
	FirstName: whereHelpernull_String{field: "\"students\".\"first_name\""},
}
...
var (
	studentAllColumns            = []string{"student_id", "last_name", "first_name"}
	studentColumnsWithoutDefault = []string{"student_id"}
	studentColumnsWithDefault    = []string{"last_name", "first_name"}
	studentPrimaryKeyColumns     = []string{"student_id"}
...
func (q studentQuery) One(ctx context.Context, exec boil.ContextExecutor) (*Student, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "dbmodels: failed to execute a one query for students")
	}
...
func (q studentQuery) Count(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "dbmodels: failed to count students rows")
	}
...
func (q studentQuery) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	...
	err := q.Query.QueryRowContext(ctx, exec).Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "dbmodels: failed to check if students exists")
	}
...
func FindStudentG(ctx context.Context, studentID int, selectCols ...string) (*Student, error) {
	return FindStudent(ctx, boil.GetContextDB(), studentID, selectCols...)
}

// FindStudent retrieves a single record by ID with an executor.
// If selectCols is empty Find will return all columns.
func FindStudent(ctx context.Context, exec boil.ContextExecutor, studentID int, selectCols ...string) (*Student, error) {
	studentObj := &Student{}
	...
	query := fmt.Sprintf(
		"select %s from \"students\" where \"student_id\"=$1", sel,
	)

	q := queries.Raw(query, studentID)
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "dbmodels: unable to select from students")
	}
...
func (o *Student) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	if o == nil {
		return errors.New("dbmodels: no students provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "dbmodels: unable to insert into students")
	}
...
func (o *Student) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return 0, errors.New("dbmodels: unable to update students, could not build whitelist")
		}
	...
	if err != nil {
		return 0, errors.Wrap(err, "dbmodels: unable to update students row")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "dbmodels: failed to get rows affected by update for students")
	}
...
func (q studentQuery) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "dbmodels: unable to update all for students")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "dbmodels: unable to retrieve rows affected for students")
	}
...
func (o *Student) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns) error {
	if o == nil {
		return errors.New("dbmodels: no students provided for upsert")
	}
	...
	if !cached {
		...
		if updateOnConflict && len(update) == 0 {
			return errors.New("dbmodels: unable to upsert students, could not build update column list")
		}
	...
	if err != nil {
		return errors.Wrap(err, "dbmodels: unable to upsert students")
	}
...
func (o *Student) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "dbmodels: unable to delete from students")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "dbmodels: failed to get rows affected by delete for students")
	}
...
func (q studentQuery) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	result, err := q.Query.ExecContext(ctx, exec)
	if err != nil {
		return 0, errors.Wrap(err, "dbmodels: unable to delete all from students")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "dbmodels: failed to get rows affected by deleteall for students")
	}
...
func (o *Student) Reload(ctx context.Context, exec boil.ContextExecutor) error {
	ret, err := FindStudent(ctx, exec, o.StudentID)
	if err != nil {
		return err
	}
...
func StudentExistsG(ctx context.Context, studentID int) (bool, error) {
	return StudentExists(ctx, boil.GetContextDB(), studentID)
}

// StudentExists checks if the Student row exists.
func StudentExists(ctx context.Context, exec boil.ContextExecutor, studentID int) (bool, error) {
	var exists bool
	sql := "select exists(select 1 from \"students\" where \"student_id\"=$1 limit 1)"

	if boil.IsDebug(ctx) {
		writer := boil.DebugWriterFrom(ctx)
		fmt.Fprintln(writer, sql)
		fmt.Fprintln(writer, studentID)
	}
	row := exec.QueryRowContext(ctx, sql, studentID)

	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "dbmodels: unable to check if students exists")
	}
...
func (o *Student) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	return StudentExists(ctx, exec, o.StudentID)
}
