...
var StudentWhere = struct {
	...
	StudentID: whereHelperint{field: "\"student\".\"student_id\""},
	LastName:  whereHelpernull_String{field: "\"student\".\"last_name\""},
	FirstName: whereHelpernull_String{field: "\"student\".\"first_name\""},
}
...
func FindStudent(ctx context.Context, exec boil.ContextExecutor, studentID int, selectCols ...string) (*Student, error) {
	...
	query := fmt.Sprintf(
		"select %s from \"student\" where \"student_id\"=$1", sel,
	)
...
func StudentExists(ctx context.Context, exec boil.ContextExecutor, studentID int) (bool, error) {
	var exists bool
	sql := "select exists(select 1 from \"student\" where \"student_id\"=$1 limit 1)"
